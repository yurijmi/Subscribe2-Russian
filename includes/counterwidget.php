...
class S2_Counter_widget extends WP_Widget {
	...
	*/
	function widget( $args, $instance ) {
		$title = empty( $instance['title'] ) ? __( 'Subscriber Count', 'subscribe2' ) : $instance['title'];
	...
	*/
	function form( $instance ) {
		...
		if ( false === $options ) {
			$defaults = array( 'title' => __( 'Subscriber Count', 'subscribe2' ), 's2w_bg' => '#e3dacf', 's2w_fg' => '#345797', 's2w_width' => '82', 's2w_height' => '16', 's2w_font' => '11' );
		} else {
